  ...
  return (
    <div style={{
      ...
      <div style={{
        ...
        <div>
          <div style={{ fontSize: 9, letterSpacing: 4, color: "#999", marginBottom: 3 }}>DIARIO DE</div>
          <div style={{ fontSize: 24, fontWeight: 700, letterSpacing: -1 }}>ENTRENAMIENTO</div>
        </div>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "flex-end", gap: 6 }}>
          <div style={{ fontSize: 11, color: "#999" }}>{formatDate(todayStr())}</div>
      ...
      {notification && (
        <div style={{
          ...
          background: "#1a1a1a", border: "1px solid #444", color: "#f5f0e8",
      ...
      {view === "today" && (
        <div style={{ padding: "0 20px" }}>
          ...
          <div style={{ padding: "14px 0 8px", display: "flex", alignItems: "center", gap: 10 }}>
            <span style={{ fontSize: 9, letterSpacing: 3, color: "#999" }}>SESIÓN</span>
          ...
          <div style={{ marginTop: 4, marginBottom: 16 }}>
            <div style={{ fontSize: 9, letterSpacing: 3, color: "#777", marginBottom: 6 }}>NOTAS</div>
            <textarea
            ...
            <div style={{ marginTop: 12 }}>
                  ...
                  {(EXERCISES_BY_GROUP[filterGroup] || []).map(name => {
                    ...
                    return (
                      <button key={name} onClick={() => addExercise(name, filterGroup)} style={{
                        background: "#141414", border: "none", color: "#ddd",
              ...
              {addTab === "custom" && (
                <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
                  {/* Zone selector */}
                  <div>
                    <div style={{ fontSize: 9, letterSpacing: 3, color: "#999", marginBottom: 8 }}>ZONA MUSCULAR</div>
                  ...
                  {/* Custom name input */}
                  <div>
                    <div style={{ fontSize: 9, letterSpacing: 3, color: "#999", marginBottom: 8 }}>NOMBRE DEL EJERCICIO</div>
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 16 }}>
              <div>
                <div style={{ fontSize: 9, letterSpacing: 3, color: "#999", marginBottom: 4 }}>PROGRESIÓN</div>
...
function Stat({ label, value }) {
  return (
    <div>
      ...
      <div style={{ fontSize: 8, color: "#777", letterSpacing: 2 }}>{label.toUpperCase()}</div>
    </div>
  );
}
    ...
    <div>
      ...
      <div style={{ marginTop: 12, display: "flex", gap: 16 }}>
        <div>
          ...
          <div style={{ fontSize: 8, letterSpacing: 2, color: "#999" }}>RÉCORD</div>
        </div>
        <div>
          <div style={{ fontSize: 18, fontWeight: 700 }}>{data.length}</div>
          <div style={{ fontSize: 8, letterSpacing: 2, color: "#999" }}>SESIONES</div>
        </div>
        <div>
          ...
          <div style={{ fontSize: 8, letterSpacing: 2, color: "#999" }}>PROGRESO</div>
        </div>
      </div>
    </div>
  );
...
function NumInput({ value, onChange, placeholder, suffix, suffixBefore }) {
  return (
    <div style={{ display: "flex", alignItems: "center", gap: 3 }}>
      {suffixBefore && <span style={{ fontSize: 11, color: "#777", width: 12 }}>{suffix}</span>}
      <input
